	...
	public boolean onCommand(CommandSender sender, Command command, String message, String[] args)
	{
		if(command.getName().equalsIgnoreCase("combattime")) {
			...
			if (sender instanceof Player && DisconnectCombat.isOnCombat() == true && DisconnectCombat.isOnCombat_ == true) {
				player.sendMessage("Vous êtes en combat, il vous reste " + DisconnectCombat.timer + " sec, une fois à 0 si vous ne vous faites pas attaquer, vous ne serez plsu en combat");
				return true;
