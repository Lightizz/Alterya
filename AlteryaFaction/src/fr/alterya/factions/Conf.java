...
public class Conf
{
	...
	public static ChatColor colorChildren = ChatColor.AQUA;
	...
	public static int factionMemberLimit = 15;
	...
	//Factions rel limits
	public static int factionChildrenLimit = 5;
	public static int factionAllyLimit = 2;
	public static int factionTruceLimit = 0;
	public static int factionEnemyLimit = 0;
...
//	public static double econCostChildren = 0.0;
