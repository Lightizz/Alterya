...
public class CmdShow extends FCommand
{
	...
	public void perform()
	{
		...
		Collection<FPlayer> child = faction.getFPlayersWhereRole(Rel.CHILDREN);
		...
		msg("<a>Status: <i>"+(faction.getOpen() ? "aucune invitation n'est requise " : " une invitation est requise"));
		...
		sendMessage(p.txt.parse("<a>Descendants : ") + TextUtil.implode(relationTags.get(Rel.CHILDREN), sepparator));
