	...
	public void promoteNewLeader()
	{
		...
		{	
			...
			if (Conf.logFactionDisband)
				Main.main.log("The faction "+this.getTag()+" ("+this.getId()+") has been disbanded since it has no members left.");
		...
		{	
			...
			Main.main.log("Faction "+this.getTag()+" ("+this.getId()+") leader was removed. Replacement leader: "+replacements.get(0).getName());
		}
	}

	public void msg(String message, Object... args)
	{
		message = Main.main.txt.parse(message, args);
