...
public class EssentialsFeatures
{
	...
	public static void integrateChat(EssentialsChat instance)
	{
		...
		try
		{
			Bukkit.getServer().getPluginManager().registerEvents(new LocalChatListener(), Main.main);
			Main.main.log("Found and will integrate chat with newer "+essChat.getDescription().getFullName());
		}
