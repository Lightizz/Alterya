...
import fr.alterya.faction.util.HealthBarUtil;
...
public class SpoutFeatures
{
	...
	public static boolean setup()
	{
		...
		Main.main.log("Found and will use features of "+plugin.getDescription().getFullName());
		mainListener = new SpoutMainListener();
		Bukkit.getPluginManager().registerEvents(mainListener, Main.main);
