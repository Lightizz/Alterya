...
public class Econ
{
	...
	public static void setup()
	{
		...
		{
			Main.main.log(integrationFail+"is not installed.");
			return;
		}
		...
		if (rsp == null)
		{
			Main.main.log(integrationFail+"is not hooked into an economy plugin.");
			return;
		}
		econ = rsp.getProvider();

		Main.main.log("Economy integration through Vault plugin successful.");

		if ( ! Conf.econEnabled)
			Main.main.log("NOTE: Economy is disabled. You can enable it with the command: f config econEnabled true");
	...
	public static void sendBalanceInfo(FPlayer to, EconomyParticipator about)
	{
		if (!shouldBeUsed())
		{
			Main.main.log(Level.WARNING, "Vault does not appear to be hooked into an economy plugin.");
			return;
		}
