...
public abstract class SpiralTask implements Runnable
{
	...
	public SpiralTask(FLocation fLocation, int radius)
	{
		...
		if (this.world == null)
		{
			Main.main.log(Level.WARNING, "[SpiralTask] A valid world must be specified!");
			this.stop();
			return;
		}
		...
		this.setTaskID(Bukkit.getServer().getScheduler().scheduleSyncRepeatingTask(Main.main, this, 2, 2));
	}
