...
public class CmdMoneyTransferFp extends FCommand
{
	...
	public void perform()
	{
		...
		if (success && Conf.logMoneyTransactions)
			Main.main.log(ChatColor.stripColor(Main.main.txt.parse("%s transferred %s from the faction \"%s\" to the player \"%s\"", fme.getName(), Econ.moneyString(amount), from.describeTo(null), to.describeTo(null))));
	}
}
