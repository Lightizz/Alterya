...
import fr.alterya.faction.event.FPlayerJoinEvent;
...
public class CmdJoin extends FCommand
{
	...
	public void perform()
	{
		...
		{
			if (samePlayer)
				Main.main.log("%s joined the faction %s.", fplayer.getName(), faction.getTag());
			else
				Main.main.log("%s moved the player %s into the faction %s.", fme.getName(), fplayer.getName(), faction.getTag());
		}
	}
}
